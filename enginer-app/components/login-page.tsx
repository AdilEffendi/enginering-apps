...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F8FAFC] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[550px] relative z-10 animate-in fade-in zoom-in-95 duration-1000 ease-out">
        <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 border border-slate-100/50 backdrop-blur-xl">
          <div className="mb-10 text-center space-y-2">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#1E293B] text-white shadow-lg mb-6 shadow-slate-200 animate-in slide-in-from-top-8 duration-1000 delay-200 fill-mode-backwards">
              <svg
            ...
            <h1 className="text-3xl font-bold text-[#1E293B] tracking-tight animate-in slide-in-from-bottom-4 duration-1000 delay-300 fill-mode-backwards">
              Selamat Datang Kembali
            </h1>
            <p className="text-slate-500 text-sm animate-in slide-in-from-bottom-4 duration-1000 delay-400 fill-mode-backwards">
              Akses dasbor teknik Anda
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4 animate-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-backwards">
              <div className="space-y-2">
                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider ml-1">Nama Pengguna</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider ml-1">Kata Sandi</label>
                <div className="relative group">
                  <input
                    type="password"
                    value={password}
